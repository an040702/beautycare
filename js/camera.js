...
;(function($){$.fn.camera = function(opts, callback) {
	...
	var defaults = {
		...
		imagePath			: 'imgslide/',	//he path to the imgslide folder (it serves for the blank.gif, when you want to display videos)
		...
		overlayer			: true,	//a layer on the imgslide to prevent the users grab them simply by clicking the right button of their mouse (.camera_overlayer)
		...
		portrait			: false, //true, false. Select true if you don't want that your imgslide are cropped
...
////////callbacks
		...
		onLoaded			: function() {  },	//this callback is invoked when the imgslide on a slide has completely loaded
		
		onStartLoading		: function() {  },	//this callback is invoked when the imgslide on a slide start loading
